...
public class FindOwnerGuildMemberByGuildId : IQuery<GuildMemberDto>
{
    ...
    private const string Sql =
        ...
        SELECT GuildMember.GuildId,
               @local_guildMemberId := GuildMember.GuildMemberId AS GuildMemberId,
        ...
        WHERE GuildMember.GuildId = @GuildId AND GuildMember.IsOwner > 0;
        ...
        WHERE MemberRole.GuildMemberId = @local_guildMemberId;
    ...
    {
        var connString = DbConnectionString + ";AllowUserVariables=True;";
        ...
        {
            return new Error("guild or member not found");
        }
